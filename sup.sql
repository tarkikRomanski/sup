...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deals` (
  `id_deals` int(11) NOT NULL AUTO_INCREMENT,
  `id_user` int(11) NOT NULL,
  `date` date DEFAULT NULL,
  `target` int(3) NOT NULL,
  `id_place` int(11) DEFAULT NULL,
  `description` text,
  PRIMARY KEY (`id_deals`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `places` (
  ...
  `name` char(124) NOT NULL,
  `position` text,
  `work_time` char(12) DEFAULT NULL,
  `adress` text,
  `description` text,
...
-- Dump completed on 2016-01-04 15:24:06
